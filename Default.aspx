...
--%><script type="text/javascript" src="js/jquery.cslider.js"></script>
	<script type="text/javascript">
        ...
        <style type="text/css" >
            ...
            #mainav ul ul{z-index:9999; position:absolute; width:148px;background: #3B3B3B; box-shadow:0px 8px 16px opx rgba(0,0,0,0.2); }
            #mainav ul ul ul{left:148px; top:0;}
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      ...
		      <ul class="nav navbar-nav" >
		        ...
		        <li> <a href="#" >Time Table &#9660;</a>
                    <ul class ="nav">
                    <li><a href="AddNewTimeTable.aspx">Create</a></li>
                    <li><a href="#">Edit &#9654;</a>
                        <ul class ="nav ">
